...
*** créer une variable  pour montrer si les stratégies de stress étaient « Oui » ou « Non ; parce que j’ai déjà vendu ces actifs ou fait cette activité au cours des 12 derniers mois et cannot continue to do it"
...
variable labels stress_coping "Le ménage s’est-il engagé dans des stratégies d’adaptation au stress?".
...
variable labels crisis_coping "Le menage s’est-il engagé dans des stratégies d’adaptation aux crises?".
...
variable labels emergency_coping "Le menage s’est-il engagé dans des stratégies d’adaptation d’urgence?".
...
Variable Labels LhCSICat = "Catégories de stratégie d’adaptation des moyens d'existance - VERSION LÉGÈRE CARI".
