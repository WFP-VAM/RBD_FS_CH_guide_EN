...
Users can substitute the stress, crisis and emergency coping strategy strategies according to their context , preferable from the list of strategies on page 47 of the CARI Manual (below).
...
[RBDstandardized_SPSSsyntaxLHCS_CARI_EN](https://github.com/WFP-VAM/RBD_FS_CH_guide_EN/blob/master/syntax/RBDstandardized_SPSSsyntaxLHCS_CARI_EN.sps) 

### R Syntax

Here is the R syntax file: 
[RBDstandardized_RsyntaxLHCS_CARI_EN](https://github.com/WFP-VAM/RBD_FS_CH_guide_EN/blob/master/syntax/RBDstandardized_RsyntaxLHCS_CARI_EN.R) 

## Standardized ENA Livehihood Coping Strategy Module



Standardized data collection form and syntax for the ENA Livelihood Coping Strategy Module is forthcoming.
