...
For privacy/data security, the code of the enumerator should be used rather than the operators actuall name.  If a particular operator nees to be identified contacted - you can refer to the .xls data collection form. 
...
This report has been designed to work with standardized variable names and indicators illustrated earlier in this guide. 
